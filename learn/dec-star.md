...
比起杂曜，神煞更偏向于一种气质，这种气质不一定会表现出什么显性的个性，更不会影响原局的一些个性。所以神煞是修饰型星曜。但是在看运限和紫占中会应用得比较广泛。48神煞分为两种类型，一种是出生后就固定的，它们产生的力量是固定的、长期的，包含长生12神和博士12神；另一种是跟随流年而变化的，他们产生的力量是流动的、有实效性的，包含流年将前12神和流年岁前12神。
