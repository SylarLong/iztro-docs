...
星曜是紫微斗数里的重要组成部分，人的个性主要收到星曜的影响。不同的星曜组合形成了不同的个性，如果你对星曜部分感兴趣，我们强烈建议你点击 [紫微斗数星曜系统](/learn/star.md) 进行相关知识学习。本篇主要关注的是开发层面。
...
- 方法
  ...
  ***
  ...
  - 用途
    ...
    判断星曜是否产生了四化，也可以传入多个四化进行判断，只要匹配到一个亮度就会返回 `true`
