...
- 方法
  ...
  ***
  ...
  - 用途
    ...
    獲取按起運先後排列的大限列表。數組索引 `0` 表示第一個大限。每一項包含大限所在宮位、起止虛歲、起止年份、干支、四化、流曜和大限十二宮。
  ...
  ***
  ...
  - 用途
    ...
    根據大限序號或本命宮位名稱，獲取該大限內的流年列表。每一項包含虛歲、年份、流年干支、四化、流曜和流年十二宮。
  ...
  ***
  ...
  - 用途
    ...
    獲取指定年份的流月列表。每一項包含虛歲、年份、月份、流月干支、四化、流曜和流月十二宮。
