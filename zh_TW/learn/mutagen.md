---
description: "紫微研習社|四化星雖然只有四顆星，但是他們缺構成了紫微鬥數的整個系統中的動態。相當於加了一個緯度，把平面的紫微鬥數星盤變成了立體的。如果說星曜的組合是代表環境的話，那四化星就是念頭。有人在逆境中精彩翻盤，也有人在順風局中一事無成。所謂的強者從不抱怨環境，這個強者，就是這個念頭。"
---
...
- A宮化忌入B宮
  ...
  忌有牽掛和煩惱的意思，所以這裏表示A宮會感覺B宮是煩惱的來源，或者A宮會讓B宮產生一些執念，可以簡單的翻譯為A宮「牽掛」著B宮，而忌入有個特性是他會 `沖` 到B宮的對宮，沖代表著一種「分離」、「分開」的概念，所以實際上C宮才是讓A宮產生煩惱的來源。
...
天干四化每個門派都有些差異，因為筆者開源庫是以《紫微鬥數全書》（陳希夷）為準，所以僅列出這一種四化排法。其他門派四化筆者並不熟悉，也沒有使用經驗，請讀者自行探索。當然，如果讀者有其他門派的四化表以及出處，希望補充到文檔中的話，請 [聯系筆者](../about.md#怎麽聯系我❓)
